...
#returns a list of the number of jobs in Junior, Intermediate, and Senior
def analytics_level_count():
    connection=sqlite3.connect("jobs.db")
...
def analytics_jobs_containing_keywords_count():
    connection=sqlite3.connect("jobs.db")
